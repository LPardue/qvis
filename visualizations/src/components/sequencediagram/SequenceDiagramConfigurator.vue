    ...
    -->
        ...
        <b-container fluid>
            <b-row>
                ...
                <b-col cols="1">
                    <b-input type="number" v-model="store.jumpToPacketNumber"/>
                </b-col>
                <b-col cols="2">
                    <b-button @click="jumpToPN(true)">Jump client packet no. </b-button>

                    <b-button @click="jumpToPN(false)">Jump server packet no.</b-button>
                </b-col>
...
<script lang="ts">
    ...
    export default class SequenceDiagramConfigurator extends Vue {
        ...
        protected jumpToPN(is_client){
            ...
            console.log("jumping to packet number", this.store.jumpToPacketNumber, "index", index);
            Vue.set(this.config, 'jumpToPacketNumber', this.store.jumpToPacketNumber);
            Vue.set(this.config, 'jumpToPacketNumberIndex', index);
        }
